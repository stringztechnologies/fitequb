	...
	return (
		<div className="min-h-screen bg-background text-on-surface font-body">
			...
			<section className="px-5 pt-6 pb-8" aria-label="Recent passes">
				<h2 className="font-headline text-lg font-bold text-on-surface mb-3">Recent Passes</h2>
				...
				{recentPasses.length === 0 ? (
					<div className="bg-surface-container-low rounded-lg p-8 text-center">
						...
						<p className="text-on-surface-variant text-sm">
							No passes sold yet. They will appear here once customers purchase day passes for your
							gym.
						</p>
					</div>
				) : (
...
function KpiCard({
	...
	const iconColor = accent === "primary" ? "text-primary" : "text-secondary-container";
	const iconBg = accent === "primary" ? "bg-primary/15" : "bg-secondary-container/15";
