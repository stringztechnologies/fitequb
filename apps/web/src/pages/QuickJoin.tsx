	...
	return (
		<div className="bg-background text-on-surface font-body min-h-screen pb-40">
			...
			<header className="fixed top-0 w-full z-50 bg-background/70 backdrop-blur-xl flex items-center gap-3 px-5 h-14">
				...
				<h1 className="font-headline font-bold text-xl text-primary-container">Quick Join</h1>
			</header>
							...
							>
								...
								<div className="flex-1 min-w-0">
									<div className="flex items-center justify-between">
										<span className="font-headline font-bold text-on-surface">{option.label}</span>
										<span
									...
									<p className="text-on-surface-variant text-xs mt-0.5">{option.description}</p>
								</div>
			...
			{/* Room Type Toggle */}
			<section className="px-5 pt-8">
				<h2 className="font-headline font-semibold text-base text-on-surface mb-1">Room Type</h2>
				<p className="text-on-surface-variant text-sm font-body mb-4">
			...
			{searchError && (
				<div className="px-5 pb-4">
					<div className="bg-error/10 border border-error/30 rounded-lg p-4 flex items-start gap-3">
						...
						<button type="button" onClick={() => setSearchError(null)} className="text-error/60">
