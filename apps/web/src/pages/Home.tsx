...
export function Home() {
	...
	useEffect(() => {
		if (isGuest) {
			// Guest: fetch public room list for the dashboard
			publicApi<EqubRoom[]>("/public/equb-rooms").then((res) => {
			...
			<header className="fixed top-0 w-full z-50 bg-[#131313]/70 backdrop-blur-xl flex justify-between items-center px-5 h-16">
				...
				<div className="flex items-center gap-3">
					<div className="flex items-center gap-1 bg-secondary-container/15 px-2.5 py-1 rounded-full">
						...
						<span className="text-sm font-bold text-secondary-container">{streak}</span>
					</div>
					<button
						type="button"
			...
			<div className="px-5 pt-5">
				{isGuest ? (
					<button
						...
						className="w-full py-4 rounded-2xl bg-gradient-to-r from-primary to-primary-container text-on-primary font-headline font-bold text-base flex items-center justify-center gap-2 shadow-lg active:scale-[0.98] transition-transform"
					>
			...
			<div className="grid grid-cols-3 gap-3 px-5 pt-5">
				...
				>
					...
					<div className="text-center">
						<p className="font-headline text-xs font-bold text-on-surface">AI Coach</p>
					</div>
				</button>
				<button
					type="button"
				...
				>
					...
					<div className="text-center">
						<p className="font-headline text-xs font-bold text-on-surface">1v1 Duel</p>
					</div>
				</button>
				<button
					type="button"
				...
				>
					<div className="w-10 h-10 rounded-lg bg-surface-container flex items-center justify-center">
						<span className="material-symbols-outlined text-xl text-on-surface-variant">help</span>
					</div>
					<div className="text-center">
						<p className="font-headline text-xs font-bold text-on-surface">How To</p>
					</div>
				</button>
			</div>
