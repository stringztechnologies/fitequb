	...
	return (
		<div className="bg-background text-on-surface font-body min-h-screen pb-40">
			...
			<header className="fixed top-0 w-full max-w-[430px] z-50 bg-[#131313]/70 backdrop-blur-xl flex items-center justify-between px-4 h-14">
				...
				<h1 className="font-headline font-bold text-lg text-on-surface">New Equb</h1>
				<div className="w-10" />
			</header>
			...
			<div className="px-5 pt-4 pb-1">
				<h2 className="font-headline text-3xl font-black leading-tight">Set the basics</h2>
				<p className="text-on-surface-variant text-sm mt-1">
					Name your Equb, set the payout, and choose how many people can join.
				</p>
			</div>

			<form id="create-equb-form" onSubmit={handleSubmit} className="px-5 pt-5 space-y-6">
				{/* Equb Name */}
				<div>
					<label
						htmlFor="equb-name"
				...
				<div>
					<div className="flex items-center justify-between mb-2">
						...
						<span className="font-headline text-2xl text-primary font-black">{members}</span>
					</div>
					<div className="flex items-center gap-3">
						<span className="font-label text-2xs text-on-surface-variant">{EQUB_MIN_MEMBERS}</span>
						<input
							id="num-participants"
							type="range"
						...
						/>
						<span className="font-label text-2xs text-on-surface-variant">{EQUB_MAX_MEMBERS}</span>
					</div>
				</div>
				...
				{/* Room Type Toggle */}
				<div>
					<p className="font-label text-xs uppercase tracking-widest text-on-surface-variant ml-1 block mb-2">
						Room Type
					</p>
				...
				<div>
					<div className="flex items-center justify-between">
						<div>
							<p className="font-label text-xs uppercase tracking-widest text-on-surface-variant ml-1 block">
								Tsom / Fasting Mode
							</p>
				...
				<div>
					<div className="flex items-center justify-between mb-3">
						<p className="font-label text-xs uppercase tracking-widest text-on-surface-variant ml-1">
							...
							>
								...
								<div className="flex items-center gap-2">
									...
									<span
										...
										style={{
											fontVariationSettings: req.selected ? "'FILL' 1" : "'FILL' 0",
										}}
									>
				...
				<div className="bg-surface-container-low p-6 rounded-lg border-l-4 border-primary shadow-2xl relative overflow-hidden">
					<div className="relative z-10">
						<div className="flex items-center gap-2 mb-4">
							...
							<span className="font-headline font-bold text-on-surface">Summary</span>
						</div>
						<div className="grid grid-cols-2 gap-4">
							...
							<div>
								...
								<span className="text-on-surface font-headline font-bold text-xl">{members}</span>
							</div>
							<div>
								<p className="font-label text-2xs text-on-surface-variant uppercase tracking-widest mb-1">
									Requirements
