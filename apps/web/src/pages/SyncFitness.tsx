	...
	return (
		<div className="min-h-screen bg-surface pb-32">
			...
			<header className="fixed top-0 w-full z-50 bg-[#131313]/70 backdrop-blur-xl flex items-center gap-3 px-5 h-16">
				...
				<h1 className="font-headline font-bold text-xl text-primary-container">Sync Fitness</h1>
			</header>
			<div className="h-16" />
			...
			<div className="px-4 pt-4 flex flex-col items-center">
				...
				<div className="relative flex items-center justify-center mb-8">
					...
					>
						<span className="material-symbols-outlined text-5xl text-surface">sync</span>
					</div>
				</div>
