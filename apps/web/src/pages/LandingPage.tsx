  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-body overflow-x-hidden">
      ...
      <section className="flex flex-col items-center justify-center min-h-[85vh] px-6 text-center relative">
        ...
        <div className="flex flex-col items-center gap-3 mt-8 relative z-10">
          <a
            ...
            className="px-10 py-4 rounded-full bg-[#0088cc] text-white text-lg font-bold no-underline flex items-center gap-3 shadow-[0_4px_30px_rgba(0,136,204,0.4)] hover:shadow-[0_4px_40px_rgba(0,136,204,0.6)] active:scale-95 transition-all"
          >
          ...
          <a
            href="/"
            className="px-8 py-3 rounded-full bg-primary/10 text-primary text-base font-bold flex items-center gap-2 hover:bg-primary/20 active:scale-95 transition-all"
          >
        ...
        {isIOS && !canInstall && (
          <p className="mt-4 text-xs text-on-surface-variant relative z-10 flex items-center gap-1.5">
            ...
            Tap Share &rarr; "Add to Home Screen" to install
          </p>
        )}
      </section>
      ...
      <footer className="py-12 px-6 text-center border-t border-outline-variant/10">
        ...
        >
          Open @fitequb_bot on Telegram &rarr;
        </a>
        <p className="mt-4 text-xs text-outline">
          Built by Stringz Technologies &mdash; Addis Ababa
        </p>
      </footer>
    </div>
  );
