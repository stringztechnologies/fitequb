...
export function DuelChallenge() {
	...
	async function handleCreateDuel() {
		...
		const text =
			"I'm challenging you to a free 1v1 Duel on FitEqub! 10k steps/day for 7 days. Accept here:";
					...
					<div className="grid gap-4">
						<div className="flex items-center gap-4">
							...
							<div className="flex-1">
								...
								<p className="font-label text-sm text-on-surface font-medium">Free</p>
							</div>
						</div>
						<div className="flex items-center gap-4">
							<span className="material-symbols-outlined text-on-surface-variant text-xl">
