...
const EqubList = lazy(() =>
  import("./pages/EqubList.js").then((m) => ({ default: m.EqubList })),
);
...
const GymList = lazy(() =>
  import("./pages/GymList.js").then((m) => ({ default: m.GymList })),
);
...
const AiCoach = lazy(() =>
  import("./pages/AiCoach.js").then((m) => ({ default: m.AiCoach })),
);
...
const Payment = lazy(() =>
  import("./pages/Payment.js").then((m) => ({ default: m.Payment })),
);
